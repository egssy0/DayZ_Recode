...
bool ImGui::tab(const char* label, bool selected)
{
    ...
    if (selected)
    {
        ...
        window->DrawList->AddRectFilled(bb.Min, ImVec2(bb.Min.x + 3, bb.Max.y), ImColor(255, 0, 0));
    }
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    ImU32 check_col = GetColorU32({ 0.37, 0.37, 0.37, 0.5 });
    ImU32 heldc = GetColorU32({ 0.51, 0.51, 0.51, 255 });
    ImU32 hoveredc = GetColorU32({ 0.44, 0.44, 0.44, 255 });
    ImU32 unhoveredc = GetColorU32({ 0.37, 0.37, 0.37, 0.37 });
    ImVec2 pad(ImMax(1.0f, IM_FLOOR(square_sz / 3.6f)), ImMax(1.0f, IM_FLOOR(square_sz / 3.6f)));
    window->DrawList->AddRect(check_bb.Min, check_bb.Max, GetColorU32((held && hovered) ? heldc : hovered ? hoveredc : unhoveredc), true, style.FrameRounding);
...
bool ImGui::Hotkey(const char* label, int* k, const ImVec2& size_arg) {
    ...
    RenderFrame(frame_bb.Min - ImVec2(7, 0), frame_bb.Max + ImVec2(0, 3), ImGui::GetColorU32(ImGuiCol_FrameBg), true, 2.f);
